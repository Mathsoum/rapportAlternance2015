...
Aboard Engineering fournie différents types de produits et de services. Je ne vais ici développer que le cas de la plateforme \gloss{orianne} sur laquelle j'ai travaillé.
...
générées suivent les spécifications \gloss{autosar}, une architecture
...
cible ou la configuration du \gloss{rtos} (définition des récurrences des
