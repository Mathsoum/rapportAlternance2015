...
\newcommand{\bigtitle}{Développement, amélioration et intégration d'outils de génération de code}
\newcommand{\shorttitle}{pour une plate-forme de prototypage de fonctions de contrôle moteur}
\newcommand{\tuteur}{Isabelle FERRAN\'E}
\newcommand{\encadrant}{Sébastien RICHE}
