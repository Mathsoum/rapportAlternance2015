...
\newcommand{\bigtitle}{Participation au développement d'une application Java EE}
\newcommand{\shorttitle}{dédiée à la conception et à la diffusion de supports pédagogiques}
...
\begin{center}\bfseries
  Stage du 3 mai 2014 au 31 juillet 2015\\Chez Aboard Engineering
\end{center}
\vfill
\ifthenelse{\equal{#1}{cover}}
{
\begin{tabular}[h]{m{5.7cm}m{5.7cm}m{5.7cm}}
\includegraphics[scale=0.45]{images/aboard.png} &
\includegraphics[scale=0.55]{images/ups.png} &
\includegraphics[scale=0.55]{images/mdl.png} \\
\end{tabular}
\vspace{1.2cm}
}{}
\begin{flushright}
